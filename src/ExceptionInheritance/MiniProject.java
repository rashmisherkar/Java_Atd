...
public class MiniProject {
	static void copyQA(File f) throws IOException {
		...
		File ans = new File("C:\\LearningJava\\FileIO\\Answers.txt");
		if(!ans.exists()) ans.createNewFile();
		
		File que = new File("C:\\LearningJava\\FileIO\\Questions.txt");
	...
	public static void main(String[] args) throws IOException {
		try {
			File f = new File("C:\\LearningJava\\FileIO\\QuestAnswer.txt");
